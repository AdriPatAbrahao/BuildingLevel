...
SEED_VECTOR_CSV = DATA_DIR / "BuildingInput.csv"
# Collection and optimization must use the same structural design space.
SEED_VECTOR_CSV_OPTIMIZATION = SEED_VECTOR_CSV
